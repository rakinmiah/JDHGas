...
export const LOCAL_TOWNS: Town[] = [
  {
    ...
    blurb:
      "From the Victorian terraces by the station to the newer estates — plus simple CP12s for the town's busy rental market.",
  ...
  },
  {
    ...
    blurb:
      "One of my closest patches — a quick trip from Burgess Hill, from Stonepound to the Keymer side.",
    ...
    faqs: [
      {
        ...
        a: "Yes. Hove is part of my regular coastal coverage — plenty of engineers travel further than that. Send me your postcode and I'll confirm what I can do and when.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    blurb:
      "An easy run from Burgess Hill — High Street cottages to the newer closes.",
  ...
  },
  {
    ...
    blurb:
      "Steep-street period houses to the newer estates — boilers in awkward spots, done properly.",
...
export const WAVE_2_TOWNS: Town[] = [
  ...
  },
  {
    ...
    intro:
      "After a gas engineer in Ditchling? I'm Jamie Hannah, Gas Safe registered in nearby Burgess Hill, and Ditchling's period cottages and village homes are right on my regular route out towards the Downs. Whether it's an annual boiler service, a landlord certificate or a repair, you get the same engineer every time and an honest, tidy job. Call 07544 063330 to book.",
    serviceAngles: {
      "gas-safety-certificate":

    ...
    <section className="border-b border-border-subtle bg-sunken">
      {image ? (
        <div className="container-page grid items-stretch gap-10 py-10 md:grid-cols-2 md:py-14 lg:gap-14">
          {copy}
          <div className="relative aspect-[4/3] w-full overflow-hidden rounded-[var(--radius-lg)] shadow-[var(--shadow-md)] ring-1 ring-border-subtle md:aspect-auto md:min-h-[22rem]">
            <Image
              src={image}
              alt={imageAlt ?? ""}
              fill
